    ...
    <div id='skills' className='relative w-full min-h-screen bg-black'>
      ...
      <div className="inset-0 flex flex-col justify-center overflow-auto items-center text-white">
        <div className="max-w-4xl mx-auto p-6">
          ...
          <a
            href="src/Resume/Manasa's Resume.pdf"  // Replace with the actual path to your CV file
            download="Manasa's Resume.pdf"      // Optional: Specify the filename when downloaded
